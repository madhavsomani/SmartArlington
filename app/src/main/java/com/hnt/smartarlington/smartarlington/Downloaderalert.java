 ...
 */
public class Downloaderalert extends AsyncTask<Void,Void,String> {
    Context c;
    String urlAddress;
    ListView lv;
    ProgressDialog pd;
    public Downloaderalert(Context c, String urlAddress, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if(jsonData==null)
        {
            ...
            //PARSE
            DataParseralert parser=new DataParseralert(c,jsonData,lv);
            parser.execute();
        }
    }
